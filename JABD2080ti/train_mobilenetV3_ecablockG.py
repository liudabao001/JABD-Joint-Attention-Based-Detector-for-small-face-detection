...
from nets.mobilenetV3 import MobileNetV3_Large_ecaG,MobileNetV3_Large_eca
...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    model_path = "logs_mobienetV3_ecablockG_eca_nonlocal/Epoch54-Total_Loss6.5421.pth"
    # -------------------------------------------------------------------#
    ...
    class RetinaFace(nn.Module):
        def __init__(self, cfg=None, pretrained=False, mode='train'):
            ...
            if cfg['name'] == 'mobilenet0.25':
                ...
                backbone = MobileNetV3_Large_ecaG()
                if pretrained:
    ...
    loss_history = LossHistory("logs_mobienetV3_ecablockG_eca_nonlocal")
    ...
    def fit_one_epoch(model_train, model, loss_history, optimizer, criterion, epoch, epoch_step, gen, Epoch, anchors,
        ...
        if (epoch + 1) % save_period == 0:
            torch.save(model.state_dict(), 'logs_mobienetV3_ecablockG_eca_nonlocal/Epoch%d-Total_Loss%.4f.pth' % (
