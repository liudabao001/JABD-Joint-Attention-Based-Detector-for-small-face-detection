...
from nets.mobilenetV3 import MobileNetV3_Large_change
...
if __name__ == "__main__":
    ...
    loss_history = LossHistory("logs_mobilenetV3_r")
    ...
    def fit_one_epoch(model_train, model, loss_history, optimizer, criterion, epoch, epoch_step, gen, Epoch, anchors,
        ...
        if (epoch + 1) % save_period == 0:
            torch.save(model.state_dict(), 'logs_mobilenetV3_r/Epoch%d-Total_Loss%.4f.pth' % (
