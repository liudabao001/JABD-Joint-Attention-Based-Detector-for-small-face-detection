...
class EPSANet(nn.Module):
    def __init__(self,block, layers, num_classes=1000):
        ...
        self.layer4 = self._make_layers(block, 256, layers[3], stride=2)
        self.layer5 = self._make_layers(block, 512, layers[4], stride=2)
...
def epsanet50():
    model = EPSANet(EPSABlock, [3, 4, 2,4, 3], num_classes=1000)
    return model
